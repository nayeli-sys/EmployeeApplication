...
public class TextCase implements java.io.Serializable {
    ...
    public static final java.lang.String _TITLE_CASE = "TITLE_CASE";
    public static final java.lang.String _UPPER_CASE = "UPPER_CASE";
    public static final java.lang.String _LOWER_CASE = "LOWER_CASE";
    public static final TextCase TITLE_CASE = new TextCase(_TITLE_CASE);
    public static final TextCase UPPER_CASE = new TextCase(_UPPER_CASE);
    public static final TextCase LOWER_CASE = new TextCase(_LOWER_CASE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://persongenderizer.genderizer.services.v4_0.soap.server.nameapi.org/", "textCase"));
    }
    /**
